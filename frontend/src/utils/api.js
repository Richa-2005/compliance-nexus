const fallbackApiBase = import.meta.env.PROD ? "https://compliancenexus-api.onrender.com" : "http://localhost:8000";

export const API_BASE = (import.meta.env.VITE_API_BASE_URL || fallbackApiBase).replace(/\/$/, "");
